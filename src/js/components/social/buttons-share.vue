    ...
    methods: {
      ...
      openPopup: function (button) {
        if (_.isFunction(links[button])) {
          ...
          windowOpen(generator(args), '', 'toolbar=0,status=0,width=626,height=436');
        }
      }
    }
  }
...
<style lang="sass" scoped>
  ...
  .button--fb {
    background-image: linear-gradient(180deg, lighten($color-fb, 10%) 0%, $color-fb 100%);
  ...
  .button--tw {
    background-image: linear-gradient(180deg, lighten($color-tw, 10%) 0%, $color-tw 100%);
  ...
  .button--ok {
    background-image: linear-gradient(180deg, lighten($color-ok, 10%) 0%, $color-ok 100%);
  ...
  .button--vk {
    background-image: linear-gradient(180deg, lighten($color-vk, 10%) 0%, $color-vk 100%);
